                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <form method="POST" action="<?php echo e(route('mapel.destroy', $data->id)); ?>">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Audrey SI Sekolah\Sistem-Informasi-Sekolah\resources\views/pages/admin/mapel/index.blade.php ENDPATH**/ ?>